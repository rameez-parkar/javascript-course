...
console.log('Population of both halves is ' + halfPopulation + ' million each.');

const tempPopulation = population + 1;
console.log('Population + 1M is ' + tempPopulation + ' million');
...
if (population > averageCountryPopulation) {
  console.log(`${country}'s population is ${population - averageCountryPopulation} million above average.`);
}
else {
...
/*
// COMMENTING THIS CODE SO THAT THE PROMPTS DON'T STUMBLE US IN THE COMING STEPS
